                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('lokasi') ? ' has-error' : '' }}">
                            <label for="lokasi" class="col-md-4 control-label">Kategori</label>
                            <div class="col-md-6">
                            <select class="form-control" name="lokasi" required="">
                                <option value="Ilmu Pengetahuan" {{$data->lokasi === "rak1" ? "selected" : ""}}>Ilmu Pengetahuan</option>
                                <option value="Dongeng" {{$data->lokasi === "rak2" ? "selected" : ""}}>Dongeng</option>
                                <option value="Novel" {{$data->lokasi === "rak3" ? "selected" : ""}}>Novel</option>
                                <option value="Kamus" {{$data->lokasi === "rak4" ? "selected" : ""}}>Kamus</option>
                            </select>
                            </div>
                        </div>
